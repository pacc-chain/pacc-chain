...
func main() {
	...
	rootCmd := &cobra.Command{
		Use:   "paccli",
		Short: "Command line interface for interacting with EPH blockchain daemon (server)",
	}

	// Add --chain-id to persistent flags and mark it required
	rootCmd.PersistentFlags().String(client.FlagChainID, "", "Chain ID of EPH node")
	...
	executor := cli.PrepareMainCmd(rootCmd, "EPH", app.DefaultCLIHome)
